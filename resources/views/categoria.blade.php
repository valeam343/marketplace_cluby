                ...
                <div class="card">
                    <div class="row no-gutters">
                        <div class="card-header border-0">
                            <img src="https://www.lavanguardia.com/r/GODO/LV/p5/WebSite/2019/01/18/Recortada/img_psola_20190118-094418_imagenes_lv_terceros_dragon-ball-super-broly-kbVE-U454190467686qgF-992x558@LaVanguardia-Web.jpg" class="img-fluid" alt="..." width="700px">
                        </div>
                        <div class="col">
            ...
            <div class="col-lg-12 col-md-12 col-xl-12 mb-12">
                <div class="card">
                    <div class="row no-gutters">
                        ...
                        <div class="col">
                            <div class="card-block px-2">
                                <h4 class="card-title">Actividad 2</h4>
                                <p class="card-text">Description</p>
                                <a href="#" class="btn btn-primary">Go somewhere</a>
                                <br>
                                <!--menus de informacion en la vista de actividad-->
                                <button class="btn btn-outline-info" data-toggle="collapse" data-target="#demo3">Informacion</button>
                                ...
                                <br>
                                <button class="btn btn-outline-info" data-toggle="collapse" data-target="#demo4">Reseñas</button>
                                ...
                                <br>
                                <button class="btn btn-outline-info" data-toggle="collapse" data-target="#demo5">Contactos</button>
                    ...
                    <div class="card-footer w-100 text-muted">Footer 2</div>
                </div>
            </div>
        </div>
        <hr>
